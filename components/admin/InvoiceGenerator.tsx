...
export default function InvoiceGenerator({
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const spacing = 3; // Space between logo and text
      
      // Set font to calculate text width accurately
      pdf.setFontSize(28);
      ...
      pdf.setFontSize(28);
      pdf.setFont('helvetica', 'bold');
      pdf.text(companyName, startX + logoSize + spacing, yPosition + 10);
      
      yPosition += 20;
      
      // Add tagline beneath logo and text
      addCenteredText('Premium E-commerce Store', yPosition, { size: 14, color: '#6b7280' });
      yPosition += 15;
